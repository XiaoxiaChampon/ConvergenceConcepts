...
A [Pew Research Center survey of 10,701 U.S. adults was conducted in March 2023](https://www.pewresearch.org/science/2023/05/16/americans-largely-positive-views-of-childhood-vaccines-hold-steady/) (let's assume everyone responded). The survey asked participants questions related to their thoughts on vaccination. One question centered around the perceived efficacy of the MMR vaccine.
...
Assuming independence between study participants, we can easily find an estimated standard error of this sample proportion:
...
- First, can we provide a range of values we are 'confident' the true proportion falls in?
    ...
    + This can be difficult to derive in some cases!
...
To do this we need to make some assumptions. We need to assume a true $p$ and a sample size $n$. Let's use the app below to consider the sampling distribution when $p$ is 0.86 and $n$ is 100.
...
```{r echo=FALSE, figures-side, fig.show="hold", out.width="50%", eval = FALSE}
...
Hopefully, the information from these figures make the point. We consider the mean because it's reliable with proven theories. Let's explore the properties of the average together so students know those numbers are trustworthy to make their choice. 
