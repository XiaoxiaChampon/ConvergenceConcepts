...
**Put the Binomial/normal CDF graph here. I'd put two of them, one where the binomail is well approximated and one where it is not.**
...
- **Put graphs of histogram for 'large sample', CDF comparison plot - need to introduce the ECDF idea**
- **Introduce the difference in CDF plot**
- **Introduce the 3D plot**

**Now do the same thing but with $n(1-max)$, describing a rule of thumb perhaps**
