...
A distribution just describes the pattern in which we observe our variable. If we can simulate observing the variable, we can create many *realizations* of $\hat{p}$ to understand the *sampling distribution*. 
...
Let's use the app at <https://shiny.stat.ncsu.edu/jbpost2/ConvergenceNotes/> to consider the sampling distribution when $p$ is 0.9 and $n$ is 10.
